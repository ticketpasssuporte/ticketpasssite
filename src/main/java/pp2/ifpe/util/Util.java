	...
	public static boolean fazerUploadImagem(MultipartFile imagem) {
		...
		if (!imagem.isEmpty()) {
			...
			try {
				...
				String workspaceProjeto = System.getProperty("user.dir") + "/C://Users/thuane/git/ticketpasssite/ticketpass/";
				File dir = new File(workspaceProjeto + "src/main/resources/img/upload/");
				if (!dir.exists()) {
					dir.mkdirs();
				}
